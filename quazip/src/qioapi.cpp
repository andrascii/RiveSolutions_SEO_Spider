   ...
   voidpf stream)
{
	Q_UNUSED(opaque);
    uLong ret;
	ret = static_cast<uLong>(((QIODevice*)stream)->pos());
    return ret;
}
   ...
   int origin)
{
    ...
    case ZLIB_FILEFUNC_SEEK_CUR :
        qiodevice_seek_result = static_cast<uLong>(((QIODevice*)stream)->pos() + offset);
        break;
    case ZLIB_FILEFUNC_SEEK_END :
        qiodevice_seek_result = static_cast<uLong>(((QIODevice*)stream)->size() - offset);
        break;
