...
#define WARNLOG LoggerConnectionServiceApi::instance()->log(LoggerConnectionServiceApi::WarningMessageType, __FUNCTION__, __FILENAME__, __LINE__)
#define ERRLOG LoggerConnectionServiceApi::instance()->log(LoggerConnectionServiceApi::ErrorMessageType, __FUNCTION__, __FILENAME__, __LINE__)
