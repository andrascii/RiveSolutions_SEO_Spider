...
{
	WebCrawler::GuiStorage::GuiStorageTypePtr storage = storageByRow(row);
...
WebCrawler::GuiStorage::GuiStorageTypePtr SummaryDataAccessorPixmapDecorator::storageByRow(int row) const noexcept
{
