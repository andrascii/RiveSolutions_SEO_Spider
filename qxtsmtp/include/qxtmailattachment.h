...
public:
    ...
    QxtMailAttachment(const QByteArray& content, const QString& contentType = QString(QLatin1String("application/octet-stream")));
    QxtMailAttachment(QIODevice* content, const QString& contentType = QString(QLatin1String("application/octet-stream")));
