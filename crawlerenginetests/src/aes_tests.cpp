...
TEST(AesTests, ECB128Crypt)
{
	QByteArray hexText, outputHex;
	QAESEncryption encryption(QAESEncryption::AES_128, QAESEncryption::ECB);
	EXPECT_EQ(encryption.encode(aesTestData.in, aesTestData.key16), aesTestData.outECB128);
}

TEST(AesTests, ECB128Decrypt)
{
	QAESEncryption encryption(QAESEncryption::AES_128, QAESEncryption::ECB);
	EXPECT_EQ(encryption.decode(aesTestData.outECB128, aesTestData.key16), aesTestData.in);
}

TEST(AesTests, ECB192Crypt)
{
	QByteArray outputHex;
	QAESEncryption encryption(QAESEncryption::AES_192, QAESEncryption::ECB);

	EXPECT_EQ(encryption.encode(aesTestData.in, aesTestData.key24), aesTestData.outECB192);
}

TEST(AesTests, ECB192Decrypt)
{
	QByteArray hexText;
	QAESEncryption encryption(QAESEncryption::AES_192, QAESEncryption::ECB);

	EXPECT_EQ(encryption.decode(aesTestData.outECB192, aesTestData.key24), aesTestData.in);
}

TEST(AesTests, ECB256Crypt)
{
	QAESEncryption encryption(QAESEncryption::AES_256, QAESEncryption::ECB);

	EXPECT_EQ(encryption.encode(aesTestData.in, aesTestData.key32), aesTestData.outECB256);
}

TEST(AesTests, ECB256Decrypt)
{
	QAESEncryption encryption(QAESEncryption::AES_256, QAESEncryption::ECB);

	EXPECT_EQ(encryption.decode(aesTestData.outECB256, aesTestData.key32), aesTestData.in);
}

TEST(AesTests, ECB256String)
{
	...
	EXPECT_EQ(QString(decodedText), inputStr);
}

TEST(AesTests, CBC128Crypt)
{
	QAESEncryption encryption(QAESEncryption::AES_128, QAESEncryption::CBC);
	EXPECT_EQ(encryption.encode(aesTestData.inCBC128, aesTestData.key16, aesTestData.iv), aesTestData.outCBC128);
}

TEST(AesTests, CBC128Decrypt)
{
	QAESEncryption encryption(QAESEncryption::AES_128, QAESEncryption::CBC);
	EXPECT_EQ(encryption.decode(aesTestData.outCBC128, aesTestData.key16, aesTestData.iv), aesTestData.inCBC128);
}

TEST(AesTests, CFB256String)
{
	...
	QByteArray encodeText = encryption.encode(inputStr.toLocal8Bit(), hashKey, aesTestData.iv);
	QByteArray decodedText = encryption.removePadding(encryption.decode(encodeText, hashKey, aesTestData.iv));
	EXPECT_EQ(QString(decodedText), inputStr);
}

TEST(AesTests, CFB256LongText)
{
	QAESEncryption encryption(QAESEncryption::AES_256, QAESEncryption::CFB);
	QString key("123456789123");

	QByteArray hashKey = QCryptographicHash::hash(key.toLocal8Bit(), QCryptographicHash::Sha256);
	QByteArray encodeText = encryption.encode(s_longText, hashKey, aesTestData.iv);
	QByteArray decodedText = encryption.removePadding(encryption.decode(encodeText, hashKey, aesTestData.iv));
	EXPECT_EQ(decodedText, s_longText);
}

TEST(AesTests, OFB128Crypt)
{
	QAESEncryption encryption(QAESEncryption::AES_128, QAESEncryption::OFB);

	EXPECT_EQ(encryption.encode(aesTestData.in, aesTestData.key16, aesTestData.iv), aesTestData.outOFB128);
}

TEST(AesTests, OFB256String)
{
