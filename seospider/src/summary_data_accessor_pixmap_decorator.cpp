...
{
	const CrawlerEngine::SequencedStorage* storage = storageByRow(row);
...
const CrawlerEngine::SequencedStorage* SummaryDataAccessorPixmapDecorator::storageByRow(int row) const noexcept
{
