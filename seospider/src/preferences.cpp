...
Preferences::Preferences(ISettingsAccessor* settingsAccessor, QObject* parent)
    ...
    , m_extractorRuleType1(-1)
    , m_extractorRuleType2(-1)
    , m_extractorRuleType3(-1)
    , m_extractorRuleType4(-1)
    , m_extractorRuleType5(-1)
    , m_extractorRuleType6(-1)
    , m_extractorRuleType7(-1)
    , m_extractorRuleType8(-1)
    , m_extractorRuleType9(-1)
    , m_extractorRuleType10(-1)
    , m_extractionType1(0)
    , m_extractionType2(0)
    , m_extractionType3(0)
    , m_extractionType4(0)
